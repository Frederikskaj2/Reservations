...
[FeatureDescription(
    ...
    """)]
public class ImportDuplicateBankTransactions(SessionFixture session) : BankTransactionsFixture(session)
{
    [Scenario]
    public Task ImportDuplicate() =>
        Runner.RunScenarioAsync(
            ...
            _ => WhenACsvFileFromBankIsImported(
                ...
                "02.04.2024";"02.04.2024";"B-BBBB";"";"1400,00";"131093,59";"Udført";"8765      0000000000"
                """),
            _ => ThenANumberOfNewTransactionsAreCreated(0));
}
