...
[FeatureDescription(
    ...
    """)]
public partial class PostingsWithTooMuchPaidOut
{
    [Scenario]
    public Task GetPostings() =>
        Runner.RunScenarioAsync(
            GivenAResident,
            GivenASettledPaidOrder,
            GivenTooMuchDepositIsRefunded,
            ...
            ThenTheThirdPostingIsForSettlingTheOrder,
            ThenTheFourthPostingIsForRefundingTheDeposit,
            ThenThereIsOneDebtor,
