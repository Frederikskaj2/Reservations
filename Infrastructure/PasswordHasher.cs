...
sealed class PasswordHasher : IPasswordHasher
{
    ...
    readonly int defaultIterationCount;
    readonly IRandomNumberGenerator randomNumberGenerator;

    public PasswordHasher(IOptions<PasswordOptions> options, IRandomNumberGenerator randomNumberGenerator)
    {
        this.randomNumberGenerator = randomNumberGenerator;
        defaultIterationCount = options.Value.Hashing.IterationCount;
    }
