...
static class Design
{
    ...
    static FontFamily GetFontFamily()
    {
        ...
        AddFont(collection, "Frederikskaj2.Reservations.EmailSender.CleaningTasks.verdana.ttf");
        // ReSharper disable once StringLiteralTypo
        AddFont(collection, "Frederikskaj2.Reservations.EmailSender.CleaningTasks.verdanab.ttf");
