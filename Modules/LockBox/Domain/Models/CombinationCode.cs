...
readonly struct CombinationCode : IEquatable<CombinationCode>
{
    ...
    public override bool Equals(object? obj) => obj is CombinationCode combinationCode && Equals(combinationCode);

    public override int GetHashCode()
        => code.Order().Aggregate(0, HashCode.Combine);
