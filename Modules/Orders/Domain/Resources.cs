...
public static class Resources
{
    ...
    public static ResourceId GetResourceIdUnsafe(string name) =>
        All.Find(resource => resource.Name == name).Match(resource => resource.ResourceId, () => throw new InvalidOperationException());
}
